    ...
    config = function()
        ...
        require('mason-lspconfig').setup {
            ...
            handlers = {
                ...
                ["lua_ls"] = require('lspconfig').lua_ls.setup(servers["lua_ls"]),
                ["svlangserver"] = require('lspconfig').svlangserver.setup(servers["svlangserver"]),
                ["clangd"] = require('lspconfig').clangd.setup(servers["clangd"]),
                ["pylsp"] = require('lspconfig').pylsp.setup(servers["pylsp"]),
            },
        }
    end,
}
